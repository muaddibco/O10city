        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Key = table.Column<string>(type: "varbinary(64)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CompromisedKeyImageId = table.Column<long>(nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    KeyImage = table.Column<string>(type: "varbinary(64)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RelationRecordId = table.Column<long>(nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    Issuer = table.Column<string>(type: "varbinary(64)", nullable: true),
                    RegistrationCommitment = table.Column<string>(type: "varbinary(64)", nullable: true),
                    GroupCommitment = table.Column<string>(type: "varbinary(64)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RootAttributeIssuanceId = table.Column<long>(nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    IssuerAddressId = table.Column<long>(nullable: true),
                    IssuanceCommitment = table.Column<string>(type: "varbinary(64)", nullable: true),
                    RootCommitment = table.Column<string>(type: "varbinary(64)", nullable: true),
                    IsOverriden = table.Column<bool>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReferencedBlockType = table.Column<ushort>(nullable: false),
                    ReferencedBodyHashPacketHashId = table.Column<long>(nullable: true),
                    ReferencedDestinationKey = table.Column<string>(type: "varbinary(64)", nullable: true),
                    ReferencedDestinationKey2 = table.Column<string>(type: "varbinary(64)", nullable: true),
                    ReferencedTransactionKey = table.Column<string>(type: "varbinary(64)", nullable: true),
                    ReferencedKeyImage = table.Column<string>(type: "varbinary(64)", nullable: true)
                },
                constraints: table =>
                {
