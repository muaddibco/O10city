    ...
    public partial class Refactoring1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.AlterColumn<long>(
                name: "LastAggregatedRegistrations",
                table: "accounts",
                nullable: false,
            ...
            migrationBuilder.AlterColumn<long>(
                name: "LastUpdatedCombinedBlockHeight",
                table: "SynchronizationStatuses",
                nullable: false,
                oldClrType: typeof(decimal),
                oldType: "decimal(20,0)");
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SpEmployeeGroupId = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SpEmployeeId = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AccountId = table.Column<long>(type: "bigint", nullable: true),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RegistrationCommitment = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    RootAttributeRaw = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SpEmployeeGroupId = table.Column<long>(type: "bigint", nullable: true)
                },
                constraints: table =>
                {
