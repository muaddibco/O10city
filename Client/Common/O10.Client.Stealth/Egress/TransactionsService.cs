...
namespace O10.Client.Stealth.Egress
{
    ...
    public class TransactionsService : TransactionsServiceBase, IStealthTransactionsService
    {
        ...
        public TransactionsService(IHashCalculationsRepository hashCalculationsRepository,
        ...
        */
        ...
        private RevokeIdentityTransaction CreateRevokeIdentityPacket(RequestInput requestInput, byte[][] issuanceCommitments)
        {
            ...
            _eligibilityProofsProvider.GetEligibilityCommitments(requestInput.EligibilityCommitment, issuanceCommitments, out int actualAssetPos, out byte[][] commitments);
            ...
            RevokeIdentityTransaction transaction = new()
            {
        ...
        private KeyImageCompromisedTransaction CreateKeyImageCompromisedTransaction(RequestInput requestInput, byte[] compromisedKeyImage, byte[] compromisedTransactionKey, byte[] destinationKey, OutputSources[] outputModels, byte[][] issuanceCommitments)
        {
            ...
            KeyImageCompromisedTransaction transaction = new()
            {
                DestinationKey = _identityKeyProvider.GetKey(destinationKey),
