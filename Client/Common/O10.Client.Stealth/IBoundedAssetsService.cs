...
namespace O10.Client.Stealth
{
    ...
    public interface IBoundedAssetsService
    {
        ...
        Task<AttributeProofs> GetAssociatedAttributeProofs(BlindingAssetInputDTO assetInput, BlindingAssetInputDTO parentAssetInput, string attributeSchemeName, byte[] externalBindingKey = null);

        Task<AttributeProofs> GetProtectionAttributeProofs(BlindingAssetInputDTO rootAssetInput, string issuer, byte[] externalBindingKey = null);

        Task<SurjectionProof> GenerateBindingProofToRoot(BlindingAssetInputDTO assetInput, BlindingAssetInputDTO parentAssetInput);
