...
import * as IdentityProviderBackActions from './identity-provider-back.actions'

@Injectable()
export class IdentityProviderBackEffects {
  ...
  constructor(private actions$: Actions<IdentityProviderBackActions.IdentityProviderBackActions>) { }
}
