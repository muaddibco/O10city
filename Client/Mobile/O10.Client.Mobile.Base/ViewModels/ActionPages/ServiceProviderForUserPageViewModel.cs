...
namespace O10.Client.Mobile.Base.ViewModels
{
    public class ServiceProviderForUserPageViewModel : ViewModelBase
    {
        ...
        private BiometricProof PrepareBiometricProof()
        {
            ...
            byte[] assetCommitment = ConfidentialAssetsHelper.GetAssetCommitment(blindingFactor, rootAttribute.AssetId);
        ...
        private async Task SendProofs(BiometricProof biometricProof, AssociatedProofPreparation[] associatedProofPreparations = null)
        {
            ...
            SurjectionProof eligibilityProof = StealthTransactionsService.CreateEligibilityProof(rootAttribute.OriginalCommitment, rootAttribute.OriginalBlindingFactor, issuanceCommitments, bf, commitmentToRoot, random);
