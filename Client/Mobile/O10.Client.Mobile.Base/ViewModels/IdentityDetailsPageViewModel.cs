    ...
    public class IdentityDetailsPageViewModel : ViewModelBase
    {
        ...
        private static RootAttributeDetailsViewModel GetRootAttributeViewModel(UserRootAttribute userRootAttribute)
        {
            return new RootAttributeDetailsViewModel
            {
                ...
                IssuanceCommitment = userRootAttribute.IssuanceCommitment.ToHexString(),
                IssuanceCommitmentVarbinary = userRootAttribute.IssuanceCommitment.ToHexString().ToVarBinary(),
                OriginalCommitment = userRootAttribute.OriginalCommitment.ToHexString(),
                OriginalCommitmentVarbinary = userRootAttribute.OriginalCommitment.ToHexString().ToVarBinary(),
