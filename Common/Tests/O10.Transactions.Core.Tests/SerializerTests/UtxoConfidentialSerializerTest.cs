...
{
    public class StealthSerializerTests : BlockchainCoreTestBase
    {
        public StealthSerializerTests(CoreFixture coreFixture, ITestOutputHelper testOutputHelper)
    ...
    //        byte[] expectedPacket = BinaryHelper.GetStealthPacket(PacketType.Stealth, syncBlockHeight, nonce, powHash, version,
    ...
    //        OnboardingRequest block = new OnboardingRequest
    //        {
    ...
    //        OnboardingRequestSerializer serializer = new OnboardingRequestSerializer();
