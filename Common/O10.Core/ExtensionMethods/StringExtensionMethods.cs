...
namespace O10.Core.ExtensionMethods
{
    public static class StringExtensionMethods
    {
        ...
        public static string ToVarBinary(this string source)
        {
            return $"0x{Encoding.ASCII.GetBytes(source).ToHexString()}";
        }
        ...
        public static unsafe byte[] HexStringToByteArray(this string source)
        {
            ...
            {
                throw new ArgumentException(string.Format(Resources.ERR_STRING_LEN_EVEN, source));
            }
		...
		public static string EncodeToString64(this string value)
		{
			return Convert.ToBase64String(Encoding.UTF8.GetBytes(value));
		}

		public static string DecodeFromString64(this string value)
		{
			return Encoding.UTF8.GetString(Convert.FromBase64String(value));
		}

        public static string EncodeToEscapedString64(this string value)
        {
            return Uri.EscapeDataString(Convert.ToBase64String(Encoding.UTF8.GetBytes(value)));
        }

        public static string DecodeUnescapedFromString64(this string value)
        {
            return Uri.UnescapeDataString(Encoding.UTF8.GetString(Convert.FromBase64String(value)));
        }
    }
}
