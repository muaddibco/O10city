...
namespace O10.Core.ExtensionMethods
{
    public static class ByteArrayExtensionMethods
    {
        ...
        /// <returns></returns>
        [ReliabilityContract(Consistency.WillNotCorruptState, Cer.MayFail)]
        public static unsafe bool Equals32(this byte[] a, Memory<byte> b)
        {
            if (a == null && b.IsEmpty)
            {
                return true;
            ...
            if (!MemoryMarshal.TryGetArray(b, out ArraySegment<byte> byteArray))
            {
            ...
            {
                byte* pa1 = a1;
                fixed (byte* b1 = byteArray.Array)
                {
                    byte* pb1 = b1 + byteArray.Offset;
                    long* pla1 = (long*)pa1;
                    long* pla2 = (long*)(pa1 + 8);
                    long* pla3 = (long*)(pa1 + 16);
                    long* pla4 = (long*)(pa1 + 24);
        ...
        /// <returns></returns>
        [ReliabilityContract(Consistency.WillNotCorruptState, Cer.MayFail)]
        public static unsafe bool Equals32(this byte[] a, byte[] b, int offset, int length)
        {
            if (a == null)
                throw new ArgumentNullException(nameof(a));
		...
		public static byte[] ComplementTo32(this byte[] a)
		{
			byte[] arr = new byte[32];
			Array.Copy(a, 0, arr, 0, Math.Min(a.Length, arr.Length));
