...
namespace O10.Transactions.Core.Serializers.Stealth
{
    ...
    {
        public GroupsRelationsProofsSerializer(IServiceProvider serviceProvider) : base(serviceProvider, LedgerType.Stealth, PacketTypes.Stealth_GroupsRelationsProofs)
        {
        }
