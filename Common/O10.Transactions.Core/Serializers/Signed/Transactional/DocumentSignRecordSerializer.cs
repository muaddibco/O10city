...
namespace O10.Transactions.Core.Serializers.Signed.Transactional
{
    ...
    {
        public DocumentSignRecordSerializer(IServiceProvider serviceProvider) : base(serviceProvider, LedgerType.O10State, PacketTypes.Transaction_DocumentSignRecord)
        {
        }
