...
namespace O10.Transactions.Core.Serializers.Signed.Transactional
{
	...
	public class transferAssetToStealthSerializer : TransactionalTransitionalSerializerBase<TransferAssetToStealth>
    {
        public transferAssetToStealthSerializer(IServiceProvider serviceProvider) 
			: base(serviceProvider, PacketType.Transactional, ActionTypes.Transaction_transferAssetToStealth)
        {
        }
