...
namespace HashLib.Crypto.SHA3
{
    internal abstract class FugueBase : BlockHash, ICryptoNotBuildIn
    {
        ...
        protected abstract void TransformBlocks(Span<byte> a_data, int a_index, int a_length);
    };
    ...
    internal abstract class Fugue256Base : FugueBase
    {
        ...
        protected override void TransformBlocks(Span<byte> a_data, int a_index, int a_length)
        {
