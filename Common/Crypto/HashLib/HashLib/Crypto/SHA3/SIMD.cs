...
namespace HashLib.Crypto.SHA3
{
    ...
    internal abstract class SIMDBase : BlockHash, ICryptoNotBuildIn
    {
        ...
        protected abstract void TransformBlock(Span<byte> a_data, int a_index, bool a_final);
    }
    ...
    internal abstract class SIMD256Base : SIMDBase
    {
        ...
        protected override void TransformBlock(Span<byte> a_data, int a_index, bool a_final)
        {
            int[] y = new int[128];
