...
namespace HashLib
{
    public interface IHash
    {
        ...
        HashResult ComputeBytes(Span<byte> a_data);
        ...
        void TransformBytes(Span<byte> a_data);
        void TransformBytes(Span<byte> a_data, int a_index);
        void TransformBytes(Span<byte> a_data, int a_index, int a_length);
