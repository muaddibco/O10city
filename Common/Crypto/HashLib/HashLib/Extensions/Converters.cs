...
namespace HashLib
{
    public static class Converters
    {
        ...
        public static uint[] ConvertBytesToUInts(Span<byte> a_in, int a_index = 0, int a_length = -1)
        {
            if (a_length == -1)
        ...
        public static void ConvertBytesToUInts(Span<byte> a_in, int a_index, int a_length, Span<uint> a_out)
        {
            Check(a_in, 1, 4, a_index, a_length);

            a_in.Slice(a_index, a_length).CopyTo(MemoryMarshal.AsBytes(a_out));
        }

        public static ulong[] ConvertBytesToULongs(Span<byte> a_in, int a_index = 0, int a_length = -1)
        {
            if (a_length == -1)
                a_length = a_in.Length;
        ...
        public static void ConvertBytesToULongs(Span<byte> a_in, int a_index_in, int a_length, Span<ulong> a_out, int a_index_out)
        {
            Check(a_in, 1, a_out, 8, a_index_in, a_length, a_index_out);
            
            a_in.Slice(a_index_in, a_length).CopyTo(MemoryMarshal.AsBytes(a_out.Slice(a_index_out)));
        }

        public static uint[] ConvertBytesToUIntsSwapOrder(Span<byte> a_in, int a_index, int a_length)
        {
            Check(a_in, 1, 4, a_index, a_length);
        ...
        public static void ConvertBytesToUIntsSwapOrder(Span<byte> a_in, int a_index, int a_length, Span<uint> a_result, int a_index_out)
        {
        ...
        public static ulong ConvertBytesToULongSwapOrder(Span<byte> a_in, int a_index)
        {
        ...
        public static ulong ConvertBytesToULong(Span<byte> a_in, int a_index)
        {
            Debug.Assert(a_index >= 0);
            Debug.Assert(a_index + 8 <= a_in.Length);

            return BitConverter.ToUInt64(a_in.Slice(a_index));
        }

        public static uint ConvertBytesToUIntSwapOrder(Span<byte> a_in, int a_index)
        {
            Debug.Assert(a_index >= 0);
        ...
        public static uint ConvertBytesToUInt(Span<byte> a_in, int a_index = 0)
        {
            Debug.Assert(a_index >= 0);
            Debug.Assert(a_index + 4 <= a_in.Length);
        ...
        public static ulong[] ConvertBytesToULongsSwapOrder(Span<byte> a_in, int a_index, int a_length)
        {
            Check(a_in, 1, 8, a_index, a_length);
        ...
        public static void ConvertBytesToULongsSwapOrder(Span<byte> a_in, int a_index, int a_length, ulong[] a_out)
        {
            Check(a_in, 1, 8, a_index, a_length);
        ...
        public static byte[] ConvertUIntsToBytesSwapOrder(uint[] a_in, int a_index = 0, int a_length = -1)
        {
            ...
            Check<uint>(a_in, 4, 1, a_index, a_length);
        ...
        public static byte[] ConvertULongsToBytes(ulong[] a_in, int a_index = 0, int a_length = -1)
        {
            ...
            Check<ulong>(a_in, 8, 1, a_index, a_length);
        ...
        public static byte[] ConvertLongsToBytes(long[] a_in, int a_index = 0, int a_length = -1)
        {
            ...
            Check<long>(a_in, 8, 1, a_index, a_length);
        ...
        public static byte[] ConvertDoublesToBytes(double[] a_in, int a_index = 0, int a_length = -1)
        {
            ...
            Check<double>(a_in, 8, 1, a_index, a_length);
        ...
        public static byte[] ConvertFloatsToBytes(float[] a_in, int a_index = 0, int a_length = -1)
        {
            ...
            Check<float>(a_in, 4, 1, a_index, a_length);
        ...
        public static ulong[] ConvertFloatsToULongs(float[] a_in, int a_index = 0, int a_length = -1)
        {
            ...
            Check<float>(a_in, sizeof(float), sizeof(ulong), a_index, a_length);
        ...
        {
            Check<float, ulong>(a_in, sizeof(float), a_out, sizeof(ulong), a_index_in, a_length, a_index_out);
        ...
        [Conditional("DEBUG")]
        private static void Check<I>(Span<I> a_in, int a_in_size, int a_out_size)
        {
            Debug.Assert((a_in.Length * a_in_size % a_out_size) == 0);
        }

        [Conditional("DEBUG")]
        private static void Check<I>(Span<I> a_in, int a_in_size, int a_out_size, int a_index, int a_length)
        {
        ...
        [Conditional("DEBUG")]
        private static void Check<I, O>(Span<I> a_in, int a_in_size, Span<O> a_result, int a_out_size, int a_index_in, int a_length, 
            int a_index_out)
        {
            Debug.Assert((a_length * a_in_size % a_out_size) == 0);
