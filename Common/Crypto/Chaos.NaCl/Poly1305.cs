...
#pragma warning disable CS0809 // Obsolete member 'Poly1305.Sign(byte[], byte[])' overrides non-obsolete member 'OneTimeAuth.Sign(byte[], byte[])'
        public override byte[] Sign(byte[] message, byte[] key)
#pragma warning restore CS0809 // Obsolete member 'Poly1305.Sign(byte[], byte[])' overrides non-obsolete member 'OneTimeAuth.Sign(byte[], byte[])'
        {
            if (message == null)
        ...
        [Obsolete("Needs more testing")]
#pragma warning disable CS0809 // Obsolete member 'Poly1305.Sign(ArraySegment<byte>, ArraySegment<byte>, ArraySegment<byte>)' overrides non-obsolete member 'OneTimeAuth.Sign(ArraySegment<byte>, ArraySegment<byte>, ArraySegment<byte>)'
        public override void Sign(ArraySegment<byte> signature, ArraySegment<byte> message, ArraySegment<byte> key)
#pragma warning restore CS0809 // Obsolete member 'Poly1305.Sign(ArraySegment<byte>, ArraySegment<byte>, ArraySegment<byte>)' overrides non-obsolete member 'OneTimeAuth.Sign(ArraySegment<byte>, ArraySegment<byte>, ArraySegment<byte>)'
        {
        ...
        [Obsolete("Needs more testing")]
#pragma warning disable CS0809 // Obsolete member 'Poly1305.Verify(byte[], byte[], byte[])' overrides non-obsolete member 'OneTimeAuth.Verify(byte[], byte[], byte[])'
        public override bool Verify(byte[] signature, byte[] message, byte[] key)
#pragma warning restore CS0809 // Obsolete member 'Poly1305.Verify(byte[], byte[], byte[])' overrides non-obsolete member 'OneTimeAuth.Verify(byte[], byte[], byte[])'
        {
            if (signature == null)
        ...
        [Obsolete("Needs more testing")]
#pragma warning disable CS0809 // Obsolete member 'Poly1305.Verify(ArraySegment<byte>, ArraySegment<byte>, ArraySegment<byte>)' overrides non-obsolete member 'OneTimeAuth.Verify(ArraySegment<byte>, ArraySegment<byte>, ArraySegment<byte>)'
        public override bool Verify(ArraySegment<byte> signature, ArraySegment<byte> message, ArraySegment<byte> key)
#pragma warning restore CS0809 // Obsolete member 'Poly1305.Verify(ArraySegment<byte>, ArraySegment<byte>, ArraySegment<byte>)' overrides non-obsolete member 'OneTimeAuth.Verify(ArraySegment<byte>, ArraySegment<byte>, ArraySegment<byte>)'
        {
            if (signature.Array == null)
                throw new ArgumentNullException("signature.Array");
            if (message.Array == null)
