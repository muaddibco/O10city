...
namespace Chaos.NaCl.Internal.Ed25519Ref10
{
    ...
    {
        static Int64 load_3(Span<byte> input, int offset)
        {
            Int64 result;
        ...
        static Int64 load_4(Span<byte> input, int offset)
        {
            Int64 result;
            result = (Int64)input[offset + 0];
            result |= ((Int64)input[offset + 1]) << 8;
        ...
        */
        ...
        /// <param name="a"></param>
        /// <param name="b"></param>
        internal static void sc_sub(Span<byte> s, Span<byte> a, Span<byte> b)
        {
            Int64 a0 = 2097151 & load_3(a, 0);
            Int64 a1 = 2097151 & (load_4(a, 2) >> 5);
            Int64 a2 = 2097151 & (load_3(a, 5) >> 2);
