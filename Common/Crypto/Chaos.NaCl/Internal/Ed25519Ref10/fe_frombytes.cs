...
namespace Chaos.NaCl.Internal.Ed25519Ref10
{
	...
	{
		private static Int64 load_3(Span<byte> data, int offset)
		{
			uint result;
		...
		private static Int64 load_4(Span<byte> data, int offset)
		{
			uint result;
			result = (uint)data[offset + 0];
			result |= (uint)data[offset + 1] << 8;
		...
		internal static void fe_frombytes(out FieldElement h, Span<byte> data, int offset)
		{
